...
/**
 * @ORM\Entity(repositoryClass=OriginLeadRepository::class)
 */
class OriginLead
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=ResumeLead::class, mappedBy="originLead", orphanRemoval=true)
     */
    private $resumeLeads;
    ...
    public function removeResumeLead(ResumeLead $resumeLead): self
    {
        if ($this->resumeLeads->removeElement($resumeLead)) {
            ...
            if ($resumeLead->getOriginLead() === $this) {
                $resumeLead->setOriginLead(null);
            }
        }
